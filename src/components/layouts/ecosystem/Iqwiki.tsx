    ...
    <div id="iq-wiki">
      ...
      <div className="border overflow-hidden rounded-xl mt-16 border-whiteAlpha-400 bg-gray700 grid md:grid-cols-3">
        <div className="col-span-1 pl-3 pt-4 lg:pl-6 lg:pt-8">
          <p className="max-w-[390px] text-sm xl:text-xl text-whiteAlpha-800">
        ...
        <div className="col-span-2">
          <div className="h-[250px] sm:h-[400px] md:h-[350px] lg:h-[400px] 2xl:h-[450px] bg-gray700 w-full relative">
            <Image
      ...
      <InViewAnimateBottom>
        <div className="flex flex-col md:flex-row gap-2 sm:gap-[18px] mt-2 sm:mt-[18px]">
          <div className="md:flex-1 rounded-xl relative overflow-hidden bg-gray700 h-[330px] sm:h-[550px] md:h-[350px] lg:h-[470px] xl:h-[440px] 2xl:h-[528px]">
            <Image
          ...
          <div className="md:flex-1 flex flex-col gap-2 sm:gap-[18px] justify-between">
            <div className="w-full relative h-[300px] sm:h-[450px] md:h-full rounded-xl bg-gray700">
              <Image
