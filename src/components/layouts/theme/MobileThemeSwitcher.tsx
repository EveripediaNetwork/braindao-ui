		...
		<li className="py-4 px-5 lg:hidden">
			<div className="flex sm:px-3 justify-between items-center">
				<div className="flex items-center gap-2">
					{!isDarkTheme ? (
						<div className="flex flex-row gap-2">
							<RiSunFill size={24} />
							<span className="flex items-center">Light Mode</span>
						</div>
					) : (
						<div className="flex flex-row gap-2">
							<RiMoonFill size={24} />
							<span className="flex items-center">Dark Mode</span>
						</div>
					)}
				</div>
				...
				<span
					...
					className="mr-0 w-10 h-5 bg-brand-500 rounded-full flex items-center px-1 dark:bg-gray-300"
				>
