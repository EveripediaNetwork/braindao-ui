    ...
    <div id="iq-wiki">
      ...
      <div className="border overflow-hidden rounded-xl mt-16 border-gray200 dark:border-whiteAlpha-400 bg-white dark:bg-gray700 grid md:grid-cols-3">
        ...
        <div className="col-span-2">
          <div className="h-[250px] sm:h-[300px] xl:h-[450px] dark:bg-gray700 w-full relative">
            {imageUrl3 && (
              <Image
                src={imageUrl3}
                alt=""
            ...
            <InViewAnimateSlideUp className="absolute top-0 left-0 w-full h-full z-10 bg-[#F9FAFB] dark:bg-gray700">
              <div></div>
      ...
      <div className="flex flex-col md:flex-row gap-2 sm:gap-5 mt-2 sm:mt-5">
        <InViewAnimateLeft className="md:flex-1 rounded-xl relative overflow-hidden dark:bg-gray700 h-[330px] sm:h-[450px] md:h-[350px] lg:h-[470px] 2xl:h-[528px]">
          {imageUrl && (
            <Image
              src={imageUrl}
              alt=""
        ...
        <InViewAnimateRight className="md:flex-1 flex flex-col gap-2 lg:gap-0 justify-between">
          <div className="w-full relative h-[300px] sm:h-[380px] md:h-[280px] lg:h-[380px] 2xl:h-[418px] rounded-xl dark:bg-gray700">
            {imageUrl2 && (
              <Image
                src={imageUrl2}
                alt=""
