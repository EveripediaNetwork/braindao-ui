...
const TeamCard = () => {
  return (
    <div className="border border-gray200 rounded-xl px-4 py-5">
      <div className="rounded-md relative h-[324px] overflow-hidden">
        <Image src={"/navin-2.png"} alt="" fill sizes="25vw" />
        <div className="absolute top-0 left-0 h-full w-full bg-transparent px-5 pb-5 flex flex-col justify-end">
          <div className="bg-white rounded-[4px] py-2 flex flex-col gap-2 items-center w-full">
            <div className="flex flex-col items-center">
              <h4 className="text-gray800 text-sm font-semibold">
                Navin Vethanayagam
              </h4>
              <p className="text-brand-500 text-xs">Chief Brain</p>
            </div>
