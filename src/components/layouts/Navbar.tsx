          ...
          <div className="flex justify-between items-center w-full">
            ...
            <div className="flex gap-2 items-center">
              <a
                ...
                target="_blank"
                className={`hidden md:flex flex-1 justify-center bg-pink-500 md:w-[184px] text-sm lg:text-base px-5 py-2 rounded-md  hover:bg-white hover:text-black transition-all ease-in-out duration-300 ${raleway.className}`}
              >
                Launch App
              </a>
              <ThemeSwitcher />
