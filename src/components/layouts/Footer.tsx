		...
		<footer className="bg-neutral-950">
			<div className="xl:container xl:mx-auto px-4 md:px-10 xl:px-4 flex flex-col gap-6 py-12">
				<div className="flex flex-col lg:flex-row gap-6 w-full">
					<div className="flex flex-col sm:flex-row w-full  gap-6 md:gap-40 lg:gap-24">
						...
						<button
							type="button"
							className="bg-primary hover:bg-primary/50 text-white px-8 py-1.5 rounded-full text-sm font-medium transition-colors whitespace-nowrap self-center mb-10"
						>
							Subscribe
						</button>
					</div>
					<div className="flex flex-col sm:flex-row w-full justify-between text-sm gap-8 lg:gap-0">
						<div>
						...
						<div>
							...
							<div className="space-y-2 flex flex-col sm:text-right text-foreground hover:text-white transition-colors">
				...
				<div className="flex flex-col lg:flex-row gap-6 w-full">
					<div className="flex flex-col gap-6 w-full">
						...
						<div className="flex flex-row items-center gap-x-3 overflow-x-auto md:overflow-visible md:flex-wrap scrollbar-hide xl:max-w-[400px]">
							{products.map((link, linkIndex) => (
								<React.Fragment key={link.name}>
									<a
										href={link.href}
										className="block text-white hover:text-gray-300 transition-colors text-xl lg:text-2xl font-light whitespace-nowrap flex-shrink-0 relative overflow-hidden group"
									>
									...
									{linkIndex < products.length - 1 && (
										<span className="text-neutral-700 text-2xl lg:text-3xl font-light flex-shrink-0">
											/
										</span>
									)}
								</React.Fragment>
					...
					<div className="flex flex-col lg:flex-row items-start lg:items-center text-muted-foreground gap-6 lg:gap-60 w-full">
						...
						<button
							type="button"
							className="text-primary self-start lg:self-center"
			...
			<div className="bg-neutral-900">
				<div className="flex flex-col md:flex-row items-center justify-between py-4 xl:container xl:mx-auto text-sm text-[#F3F4F6] px-4 md:px-10 xl:px-4">
