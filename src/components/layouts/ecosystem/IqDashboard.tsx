...
const IqDashboard = () => {
  ...
  let imageUrl;
  if (appTheme === "light") {
    imageUrl = "/iq-dashboard-mockup.png";
  }
  if (appTheme === "dark") {
    imageUrl = "/iq-dashboard-mockup-dark.png";
  }

  return (
    <div className="max-w-[1536px] mx-auto flex flex-col gap-10 xl:gap-16 py-[80px] xl:py-24">
...
"
      ...
      <div className="w-full relative h-[500px] lg:h-[600px] xl:h-[887px]">
