		...
		<div className="relative overflow-hidden pb-8">
			...
			<div className="relative">
				<div className="max-w-[1536px] mx-auto">
					<Navbar />
					<div
						className="flex flex-col items-center w-full h-[100vh] justify-center relative overflow-hidden 
						pt-0 md:pt-20 lg:pt-2 pb-72 sm:pb-80 md:pb-[24rem] lg:pb-[32rem] xl:pb-32 -mt-20 md:-mt-32  xl:pt-0 xl:-mt-16"
					>
