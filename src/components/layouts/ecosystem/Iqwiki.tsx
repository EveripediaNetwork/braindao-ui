  ...
  return (
    <>
      ...
      <div className="flex flex-col lg:flex-row gap-5 mt-5">
        <div className="lg:flex-1 bg-wiki-image bg-no-repeat bg-contain rounded-xl overflow-hidden bg-center dark:bg-wiki-widget-dark h-[688px] lg:h-[528px]" />
        <div className="flex-1 flex flex-col gap-10 lg:gap-0 justify-between">
          <div className="w-full h-[558px] lg:h-[418px] bg-center bg-wiki-rank bg-no-repeat bg-contain dark:bg-wiki-rank-dark" />
