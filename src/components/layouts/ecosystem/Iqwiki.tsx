  ...
  return (
    <div id="iq-wiki">
      ...
      <div className="flex flex-col md:flex-row gap-5 mt-5">
        <div className="md:flex-1 rounded-xl relative overflow-hidden dark:bg-gray700 h-[530px] sm:h-[450px] md:h-[350px] lg:h-[470px] 2xl:h-[528px]">
          {imageUrl && (
            <Image
              src={imageUrl}
              alt=""
        ...
        <div className="md:flex-1 flex flex-col gap-4 md:gap-2 lg:gap-0 justify-between">
          <div className="w-full relative h-[418px] sm:h-[380px] md:h-[280px] lg:h-[380px] 2xl:h-[418px] rounded-xl dark:bg-gray700">
            {imageUrl2 && (
              <Image
                src={imageUrl2}
                alt=""
          ...
          <div className="p-3 lg:p-5 flex items-center bg-white dark:bg-gray700 border border-gray200 dark:border-whiteAlpha-400 justify-between gap-2 rounded-xl">
            ...
            <div className="flex md:gap-3 lg:gap-6 items-center xl:gap-8">
              <div className="w-10 h-10 md:w-8 md:h-8 lg:w-10 lg:h-10 2xl:w-12 2xl:h-12 bg-eth bg-contain bg-no-repeat" />
              <div className="w-10 h-10 md:w-8 md:h-8 lg:w-10 lg:h-10 2xl:w-12 2xl:h-12 bg-graph bg-contain bg-no-repeat" />
              <div className="w-10 h-10 md:w-8 md:h-8 lg:w-10 lg:h-10 2xl:w-12 2xl:h-12 bg-coingecko bg-contain bg-no-repeat" />
