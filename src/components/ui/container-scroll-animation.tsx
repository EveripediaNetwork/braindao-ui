...
// New compact version with reduced height and padding
export const CompactContainerScroll = ({
	titleComponent,
	children,
}: {
	titleComponent: string | React.ReactNode;
...
export const Card = ({
	...
	return (
		<motion.div
			...
			className="max-w-5xl -mt-12 mx-auto h-[30rem] md:h-[40rem] w-full border-none p-2 md:p-6 rounded-[30px] shadow-2xl"
		>
