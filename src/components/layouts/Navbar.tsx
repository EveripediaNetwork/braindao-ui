					...
					<div className='flex justify-between items-center w-full'>
						...
						<div className='flex gap-2 items-center'>
							<a
								...
								target='_blank'
								className={`hidden md:flex flex-1 justify-center bg-brand-700 hover:bg-brand-700 md:w-[184px] text-sm lg:text-base px-5 py-2 rounded-md transition-all ease-in-out duration-300 ${raleway.className}`}
							>
								Launch Dashboard
							</a>
							<NavBarButton />
