			...
			<div className='max-w-[1536px] mx-auto'>
				<header className=' flex flex-col z-50 lg:-mx-7 lg:px-14 p-3'>
					<div className='flex justify-between items-center w-full'>
						...
						<nav className='hidden lg:flex gap-20 text-sm lg:text-base'>
							{navLinks.map((link) => (
								<a
									target='_blank'
									href={link.href}
						...
						<div className='flex gap-2 items-center'>
							<a
								...
								target='_blank'
								className={`hidden md:flex justify-center bg-pink-500 md:w-[184px] text-sm lg:text-base px-5 py-2 rounded-md  hover:bg-white hover:text-black transition-all ease-in-out duration-300 ${raleway.className}`}
							>
								Launch App
							</a>
							<ThemeSwitcher />
