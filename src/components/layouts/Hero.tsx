...
const Hero = () => {
  return (
    <div className="relative bg-hero-image bg-cover bg-top text-whiteAlpha-900">
      <div className="max-w-[1536px] mx-auto">
        <div className="flex flex-col items-center w-full justify-center relative overflow-y-hidden h-[calc(85vh-65px)] md:h-[calc(60vh-65px)] lg:h-[calc(100vh-65px)]">
          <div className="flex text-center md:text-left items-center md:items-start flex-col justify-start mx-auto gap-5 w-full  max-w-6xl mr-auto -translate-y-10">
            <h1
              className={`md:text-5xl xl:text-[70px] !leading-tight text-center font-bold ${space_grotesk.className}`}
            >
