					...
					<div className='bg-white dark:bg-gray700 relative rounded-[4px] py-2 px-1 flex flex-col gap-2 items-center w-full'>
						...
						<div className='flex justify-center'>
							<div className='flex gap-2'>
								<div className='w-4 h-4 bg-twitter bg-no-repeat bg-contain dark:bg-twitter-dark' />
								<div className='w-4 h-4 bg-linkedln bg-no-repeat bg-contain dark:bg-linkedln-dark' />
							</div>
						</div>
					</div>
				</div>
