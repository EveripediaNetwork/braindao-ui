...
const Iqgpt = () => {
  ...
  let imageUrl;
  if (appTheme === "light") {
    imageUrl = "/iq-gpt-mockup.png";
  }
  if (appTheme === "dark") {
    imageUrl = "/iq-gpt-mockup-dark.png";
  }
  return (
    <div className="max-w-[1536px] px-10 xl:px-[120px] mx-auto flex flex-col gap-10 xl:gap-16 py-[80px] xl:py-24">
      <TokenBrief
        title="IQ GPT"
