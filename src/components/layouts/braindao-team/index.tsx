								...
								<div className='flex gap-2'>
									{twitterLink && (
										<a
											href={twitterLink}
											target='_blank'
											className='w-4 h-4 bg-no-repeat bg-contain bg-twitter-dark dark:bg-twitter'
										/>
									)}
									{linkedlnLink && (
										<a
											href={linkedlnLink}
											target='_blank'
											className='w-4 h-4 bg-no-repeat bg-contain bg-linkedln-dark dark:bg-linkedln'
										/>
									)}
								</div>
							</div>
...
const BraindaoTeam = () => {
	return (
		<div className='bg-gray800 dark:bg-white text-whiteAlpha-900 dark:text-gray600'>
			<div className='max-w-[1536px] px-4 md:px-20 xl:px-24 2xl:px-[120px] mx-auto py-[48px] sm:py-[80px] 2xl:py-24'>
				<h2 className='text-center text-3xl sm:text-4xl xl:text-5xl text-whiteAlpha-900 dark:text-gray800 font-semibold mb-10 xl:mb-14'>
					Humans of BrainDAO
				</h2>
