...
const Hero = () => {
  ...
  return (
    <div onMouseMove={manageMouseMove}>
      <div className="relative bg-braindao-sm sm:bg-hero bg-cover bg-no-repeat bg-center text-whiteAlpha-900">
        <Navbar />
        <div
          ref={plane}
          className="hidden sm:block bg-brainie bg-cover bg-center bg-no-repeat w-full h-[800px] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"
        />
