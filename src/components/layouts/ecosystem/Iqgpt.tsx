...
const Iqgpt = () => {
  ...
  if (appTheme === "dark") {
    imageUrl = "/images/iqgpt-mockup-dark-new.png";
  }
  return (
    <div
      id="iq-gpt"
      className="max-w-[1536px] px-4 sm:px-10 xl:px-[120px] mx-auto flex flex-col gap-10 xl:gap-16 py-[48px] sm:py-[80px] xl:py-24"
    >
      <TokenBrief
        title="IQ GPT"
      ...
      <div className="w-full relative h-[320px] sm:h-[600px] md:h-[700px] lg:h-[850px] xl:h-[1000px] 2xl:h-[1117px]">
